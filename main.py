...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ds_iter", type=int, default=100000, help="Number of iterations to optimize diversity sensitive loss"
    )
    ...
    parser.add_argument(
        "--num_outs_per_domain", type=int, default=10, help="Number of generated images per domain during sampling"
    )
    parser.add_argument(
        "--dataparallel", action="store_true", help="Whether to run training using data parallel models"
    )
    ...
    parser.add_argument(
        "--train_img_dir", type=str, default="data/celeba_hq/train", help="Directory containing training images"
    )
    parser.add_argument(
        "--val_img_dir", type=str, default="data/celeba_hq/val", help="Directory containing validation images"
    )
    parser.add_argument("--sample_dir", type=str, default="expr/samples", help="Directory for saving generated images")
    parser.add_argument(
        "--checkpoint_dir", type=str, default="expr/checkpoints", help="Directory for saving network checkpoints"
    )

    # directory for calculating metrics
    parser.add_argument(
        "--eval_dir", type=str, default="expr/eval", help="Directory for saving metrics, i.e., FID and LPIPS"
    )

    # directory for testing
    parser.add_argument(
        "--result_dir", type=str, default="expr/results", help="Directory for saving generated images and videos"
    )
    parser.add_argument(
        "--src_dir",
        type=str,
    ...
    parser.add_argument(
        "--inp_dir", type=str, default="assets/representative/custom/female", help="input directory when aligning faces"
    )
    parser.add_argument(
        "--out_dir",
        type=str,

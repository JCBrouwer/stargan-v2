    ...
    for trg_idx, trg_domain in enumerate(domains):
        ...
        for src_idx, src_domain in enumerate(src_domains):
            ...
            loader_src = get_eval_loader(
                root=path_src, img_size=args.img_size, batch_size=args.val_batch_size, imagenet_normalize=False
            )
    ...
    for trg_domain in domains:
        ...
        for src_domain in src_domains:
            ...
            fid_value = calculate_fid_given_paths(
                paths=[path_real, path_fake], img_size=args.img_size, batch_size=args.val_batch_size
            )
